export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'fusionlinker',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Fusionlinker',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'fusionlinker.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://fusionlinker.com',

...
export const editableRootStyle = {
  // Reactor-inspired editorial system: flat red masthead, black rules,
  // white reading surfaces, and a dark footer.
  '--slot4-page-bg': '#ffffff',
  '--slot4-page-text': '#050505',
  '--slot4-panel-bg': '#f6f6f2',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#55524c',
  '--slot4-soft-muted-text': '#77736b',
  '--slot4-accent': '#d5362b',
  '--slot4-accent-fill': '#d5362b',
  '--slot4-accent-soft': '#f7dad5',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#000000',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#efeee9',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f3f2ec',
  ...
  '--editable-page-text': '#050505',
  '--editable-container': '1664px',
  '--editable-border': '#d8d3c8',
  '--editable-nav-bg': '#d5362b',
...
export const editableDesignContract = {
  ...
  layout: {
    ...
    minRailCard: 'w-[230px] shrink-0 snap-start sm:w-[280px]',
  },
  type: {
